...
class Inception(nn.Module):
  ...
  def __init__(self):
    ...
    self.branch3x3_reduce = BasicConv2d(256, 48, kernel_size=1, padding=0)
    self.branch3x3 = BasicConv2d(48, 64, kernel_size=3, padding=1)
    self.branch3x3_reduce_2 = BasicConv2d(256, 48, kernel_size=1, padding=0)
...
class FaceBoxes(nn.Module):
  ...
  def __init__(self, phase, size, num_classes):
    ...
    self.conv1 = CRelu(3, 48, kernel_size=7, stride=4, padding=3)
    self.conv2 = CRelu(96, 128, kernel_size=5, stride=2, padding=2)
    
    self.inception1 = Inception()
    self.inception2 = Inception()
    self.inception3 = Inception()
    
    self.conv3_1 = BasicConv2d(256, 256, kernel_size=1, stride=1, padding=0)
    self.conv3_2 = BasicConv2d(256, 512, kernel_size=3, stride=2, padding=1)
    
    self.conv4_1 = BasicConv2d(512, 256, kernel_size=1, stride=1, padding=0)
